#ifndef ELASTICSEARCH_IMAGES_REQUEST_SEARCH_HPP
...
public:
    ...
    using model_t = elasticsearch::image::model::data;
    using response = elasticsearch::v7::search::response<model_t>;

    using base_t::base_t;

    static constexpr const char *name() { return "image/search"; }
/*
...
#endif // ELASTICSEARCH_IMAGES_REQUEST_SEARCH_HPP

...
template<template<class> class Cmp, class Element>
struct CmpWrap : public Cmp<typename Element::value_t>
{
...
public:
    ...
    template<template<class> class Cmp, class ElementValueT = element_value_t>

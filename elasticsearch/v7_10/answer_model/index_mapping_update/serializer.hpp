#ifndef ELASTICSEARCH_7_10_ANSWER_MODEL_INDEX_MAPPING_UPDATE_MODEL_SERIALIZER_HPP
#define ELASTICSEARCH_7_10_ANSWER_MODEL_INDEX_MAPPING_UPDATE_MODEL_SERIALIZER_HPP
                                                            ...
                                                            ::model::Properties<SpecificModel>)
{
    ...
    {
        tracer.trace(__FUNCTION__, " - skip request by itself");

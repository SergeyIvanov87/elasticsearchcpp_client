#ifndef ELASTICSEARCH_7_10_REQUEST_INDEX_MAPPING_UPDATE_HPP
#define ELASTICSEARCH_7_10_REQUEST_INDEX_MAPPING_UPDATE_HPP

#include "elasticsearch/v7_10/request/put_data.hpp"

#include "elasticsearch/v7_10/answer_model/index_mapping_update/models.hpp"
#include "elasticsearch/v7_10/answer_model/index_mapping_update/serializer.hpp"
...
public:
    ...
    using response = elasticsearch::v7::index_mapping_update::response;

    static constexpr const char *name() { return "v7/index_mapping_update"; }
...
#endif // ELASTICSEARCH_7_10_REQUEST_INDEX_MAPPING_UPDATE_HPP

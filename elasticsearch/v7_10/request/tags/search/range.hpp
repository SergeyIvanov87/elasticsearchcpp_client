...
namespace create
{
    template<class Model, class SpecificModelParam, template<class> class Limit,
             class = std::enable_if_t<::model::search::details::enable_for_node_args<::model::search::Range<Model, SpecificModelParam>,
    ...
    range_element<Model, SpecificModelParam> range_tag(const Limit<typename SpecificModelParam::value_t> &l)
    {
        return range_element<Model, SpecificModelParam> (l);
    }
    ...
    range_element<Model, SpecificModelParam> range_tag(const Limit1<typename SpecificModelParam::value_t> &l1,
                                                       const Limit2<typename SpecificModelParam::value_t> &l2)
    {
        return range_element<Model, SpecificModelParam> (l1, l2);
    }
} // namespace create
} // namespace tag
} // namespace search
